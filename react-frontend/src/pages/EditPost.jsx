  ...
  useEffect(() => {
    getPostById(postId)
      .then(data => {
        ...
        setForm({ ...form, title, summary, content, category, timeToRead: time_to_read  })
      })
  }, [])
        ...
        <Col md={10} >
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Control 
              ...
              value={timeToRead}
              onChange={handleFormChange} />
            <Button type='submit' size='lg' variant='outline-secondary py-3 fs-5 mb-4'>Edit Post</Button>
          </Form>
      </Col>
      </Row>
    </Container>
